...
<body>
  ...
  <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
    <div class="container">
      <div class="d-sm-flex flex-sm-row-reverse align-items-center">
        <img src="img/img_2.png" class="img-fluid" width="300" />
        <div>
      ...
      <div id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="img/img_4.jpeg" class="d-block w-100" alt="..." />
          </div>
          <div class="carousel-item">
            <img src="img/img_5.jpeg" class="d-block w-100" alt="..." />
          </div>
          <div class="carousel-item">
            <img src="img/img_6.jpeg" class="d-block w-100" alt="..." />
          </div>
        </div>
        <button
    ...
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-center">
        ...
        <div class="p-md-5 text-sm-start">
          <h3 class="lead">A11.2023.15460</h3>
          <h1 class="fw-bold">Aldio Sebastiansyah</h1>
  ...
  <footer id="footer" class="text-center p-5">
    <div>
      ...
      <a href="https://wa.me/+628136764026"><i class="bi bi-whatsapp h2 p-2"></i></a>
    </div>
    <div>Aldio Sebastiansyah &copy; 2024</div>
  </footer>
  <!-- footer end -->
